...
- `openspec/changes/` holds active work; `openspec/changes/archive/YYYY-MM-DD-<name>/`
  holds shipped changes. **The active queue contains `reduce-roadmap-agent-context`** —
  seventeen changes have shipped, the latest being `unit-06-negatives`, archived 2026-08-07.
