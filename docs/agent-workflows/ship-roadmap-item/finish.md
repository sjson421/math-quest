...
Report selected item/increment, exploration decision and every forward amendment, change
name, implementation, audit/review corrections, review mode and fallbacks, exact gate results,
