...
3. **Stage D** (50) — the biggest. Needs **KaTeX** from Unit 7 onward, and a **fraction
   input mode** on the keypad (already stubbed via `allowFraction`).
...
| Fraction keypad mode | D (Unit 8) | `allowFraction` flag already exists |
