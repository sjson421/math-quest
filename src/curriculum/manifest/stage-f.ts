 ...
 * alongside choice input for quadrant reading, expression input for polynomial
 * answers, root-pair input for two quadratic roots, and math notation for the
 * slope and quadratic formulas.
 */
