...
sources. It SHALL reject missing operation data, unsupported display and operation pairings, a
favourable count outside its total, a probability that reaches 0 or 1, mismatched visible text
or prompts, and any stated answer that disagrees with the derivation.
