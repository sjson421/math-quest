...
**Reason**: Its Unit 18b scenario requires all five Unit 19 skills to remain planned and the
playable total to remain 168, which becomes false when Unit 19 completes Stage F.

**Migration**: Replace it with `Stage capability requirements remain complete after Unit 19`,
which preserves the capability contract and all still-current scenarios while advancing Stage
F to 28 implemented skills and the playable total to 173.
