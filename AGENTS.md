...
- `openspec/changes/` holds active work; `openspec/changes/archive/YYYY-MM-DD-<name>/`
  holds shipped changes. **`unit-04-division` is active** and archives as soon as it ships;
  thirteen changes have shipped before it, the latest being `unit-03-multiplication`,
  archived 2026-08-03.
